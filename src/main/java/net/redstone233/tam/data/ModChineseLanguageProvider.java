...
public class ModChineseLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        ...
        // 超级熔炉
        translationBuilder.add("rpm.ponder.super_furnace.header", "超级熔炉建造指南");
        translationBuilder.add("rpm.ponder.super_furnace.text_1", "超级熔炉：大幅提升熔炼效率的特殊结构");
        translationBuilder.add("rpm.ponder.super_furnace.text_2", "开始建造第1层：3x3石头基底");
        translationBuilder.add("rpm.ponder.super_furnace.text_3", "建造第2层：注意中间位置");
        translationBuilder.add("rpm.ponder.super_furnace.text_4", "中间位置放置熔炉");
        translationBuilder.add("rpm.ponder.super_furnace.text_5", "建造第3层：3x3石头顶盖");
        translationBuilder.add("rpm.ponder.super_furnace.text_6", "完成！超级熔炉可以大幅提升熔炼速度");
        ...
        // 超级烟熏炉
        translationBuilder.add("rpm.ponder.super_smoker.header", "超级烟熏炉建造指南");
        translationBuilder.add("rpm.ponder.super_smoker.text_1", "超级烟熏炉：快速熏制食物的特殊结构");
        translationBuilder.add("rpm.ponder.super_smoker.text_2", "第1层：煤炭块与木头十字交错排列");
        translationBuilder.add("rpm.ponder.super_smoker.text_3", "第2层：保持十字结构，中心放置烟熏炉");
        translationBuilder.add("rpm.ponder.super_smoker.text_4", "中心放置烟熏炉");
        translationBuilder.add("rpm.ponder.super_smoker.text_5", "第3层：与第1层完全对称");
        translationBuilder.add("rpm.ponder.super_smoker.text_6", "完成！超级烟熏炉大幅提升食物熏制速度");

        // 新增分类标签
        translationBuilder.add("rpm.furnace.tag.title", "超级熔炉");
        translationBuilder.add("rpm.furnace.tag.description", "高效熔炼设备的建造指南");
    }
}